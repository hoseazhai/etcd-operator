...
import (
	...
	"github.com/hoseazhai/etcd-operator/controllers"
...
var (
	...
	defaultBackupImage = "registry.cn-beijing.aliyuncs.com/kaite-open/etcd-operator-backup:v0.0.1"
)
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "e49810f0.jepaas.com",
	})
	if err != nil {
